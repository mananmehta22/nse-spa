// Please refer comments from AddEdit.js as it is same as that, no need for recursion
...
const AddEdit = () => {
  ...
  useEffect(() => {
    axios.get(`http://localhost:5000/jan_19/get/${sr_no}`)
  ...
  const handleSubmit = (e) => {
    ...
    if (!security_symbol || ! security_name || !industry || !equity_cap || !free_float || !weightage || !r2 || !volatility || !monthly_return || !avg_imp_cost) {
      ...
      axios
        .put(`http://localhost:5000/jan_19/update/${sr_no}`, {
            security_symbol, 
            security_name, 
            industry, 
            equity_cap, 
